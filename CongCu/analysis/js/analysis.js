...
function submit(){   
    ...
    if(document.getElementById("uname").value=="" || document.getElementById("psw").value==""){
        ...
        var qu_AllData = 'Select A, D WHERE A = \"' + u + '\" AND B = \"' + p + '\"';            
...
function goToLinkCongCuLuyenThi(){
    //Up
    setCookie("usr", user, 2);
    //Up
    var linkCongCuLuyenThi = "";
    if(valueLevel == 1){
        linkCongCuLuyenThi = "http://localhost/3_Website_LuyenIC3/CongCu-DeCode/analysis/IC3GS6LEVEL1.html";
        window.location.href = linkCongCuLuyenThi;
    }
    else if(valueLevel == 2){
        linkCongCuLuyenThi = "http://localhost/3_Website_LuyenIC3/CongCu-DeCode/analysis/IC3GS6LEVEL2.html";
        window.location.href = linkCongCuLuyenThi;
    }
    else if(valueLevel == 3){
        linkCongCuLuyenThi = "http://localhost/3_Website_LuyenIC3/CongCu-DeCode/analysis/IC3GS6LEVEL3.html";
        window.location.href = linkCongCuLuyenThi;
    }
}
